...
function parseRooms(v) {
  ...
  // «ЕВРО 2», «евро-1» — кухня-гостиная не считается жилой комнатой,
  // поэтому «ЕВРО N» классифицируем как N-комнатную (обычная рыночная
  // интерпретация: евро-двушка = 2к, евро-однушка = 1к).
  const euro = s.match(/евро\s*-?\s*(\d+)/)
