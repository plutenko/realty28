...
export async function collectUnitsFromMacroCrmSource(source) {
  ...
  // MacroCRM API не отдаёт position. Считаем относительно минимального номера на этаже:
  //   position = number - minNumberOnFloor + 1
  // Так пропущенные в продаже номера (62, 63 между 61 и 64) становятся визуальными пропусками
  // в шахматке — именно так рисует застройщик на своём сайте.
