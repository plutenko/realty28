 ...
 * Используется при синке Profitbase (ряд доски ≠ маркетинговый этаж) и Google Sheets
 * Содружество (в xlsx колонка «этаж» иногда сдвигается при экспорте/объединении ячеек).
 *
 * @param {unknown} num
 * @returns {number | null}
 */
